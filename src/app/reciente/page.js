    ...
    <main>
      ...
      <div className={styles.titcontent}>
        ...
        <div className={styles.img}>
          <Image src='/static/img/galaxy-planets-solar.png' height={400} width={400} alt='solar' />
        </div>
        <div>
        ...
        <div className={styles.img}>
          <Image src='/static/img/venus_galaxy_planet.png' height={300} width={300} alt='venus' />
        </div>
      </div>
    </main>
  );
