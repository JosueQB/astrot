    ...
    <main>
      ...
      <div className={styles.titcontent}>
        ...
        <div className={styles.cont} >
          <img src="../../../static/img/about-icon.png" />
        ...
        <div>
          <center><img src="../../../static/img/galaxy-planets-solar.png" height={400} width={400}/></center>
        </div>
        <div>
        ...
        <div>
          <center><img src="../../../static/img/venus_galaxy_planet.png" height={300} width={300}/></center>
        </div>
      </div>
    </main>
  );
